...
import { FiMapPin, FiCalendar, FiTrash2, FiEdit2, FiExternalLink, FiStar, FiClock, FiNavigation, FiHeart, FiShare2, FiUsers, FiActivity } from 'react-icons/fi';
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
          >
            Back to Dashboard
          </button>
        </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
            ...
            <div className="flex gap-3 mt-4 lg:mt-0">
              ...
              <button
                ...
                className="p-3 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl hover:from-red-600 hover:to-pink-600 transition-all duration-200 shadow-lg hover:shadow-xl"
                title="Delete plan"
              >
                <FiTrash2 size={20} />
              </button>
          ...
          <div className="flex gap-3 mt-6 pt-6 border-t border-gray-200">
            {plan.status === 'planning' && (
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
            ...
            {plan.status === 'in_progress' && (
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
                <FiCheck size={18} />
                Mark Complete
              </button>
            )}
            <button className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
              <FiShare2 size={18} />
              Share Plan
            </button>
          </div>
            ...
            {plan.activities && plan.activities.length > 0 ? (
              <div className="space-y-4">
                {plan.activities.map((activity, idx) => (
                  <div 
                    key={idx} 
                    className="group bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100/50 hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <h3 className="font-bold text-gray-900 text-xl mb-2">{activity.name}</h3>
                      ...
                      {activity.location?.coordinates && (
                        <a
                          ...
                          className="p-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-200 shadow-lg hover:shadow-xl"
                    ...
                    {activity.notes && (
                      <p className="text-sm text-gray-600 bg-white/50 rounded-lg p-3 border border-white/50">
                        {activity.notes}
                      </p>
                    )}
                  </div>
              ...
              <div className="text-center py-12">
                ...
                <button
                  onClick={() => navigate(`/plan/edit/${id}`)}
                  className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
                >
                ...
                <form onSubmit={handleAddReview} className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 px-6 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
                    >
                      Cancel
                    </button>
                  </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20">
              <div className="flex items-center justify-between mb-6">
                ...
                {!showReviewForm && (
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl flex items-center gap-2"
                  >
                    <FiEdit2 size={18} />
                    Add Review
                  </button>
              ...
              {reviews.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={() => setShowReviewForm(true)}
                    className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
                  >
                    Write First Review
                  </button>
                </div>
