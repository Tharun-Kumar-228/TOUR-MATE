...
import { FiMapPin, FiSearch, FiPlus, FiTrash2 } from 'react-icons/fi';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Edit Your Plan</h1>
          <p className="text-gray-600">Update your tour itinerary</p>
        </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  {searchLoading ? 'Searching...' : 'Search Nearby Places'}
                </button>
              </div>
