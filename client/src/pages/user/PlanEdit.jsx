...
import { FiMapPin, FiSearch, FiPlus, FiTrash2, FiEdit2, FiCalendar, FiClock, FiNavigation, FiArrowRight, FiCheck, FiInfo, FiSave } from 'react-icons/fi';
...
export default function PlanEdit() {
  ...
  const steps = [
    ...
    { number: 3, title: 'Activities', description: 'Update your itinerary' },
  ];
  ...
  const fetchPlan = async () => {
    try {
      ...
      if (plan.destination.location.coordinates.length > 0) {
        setSelectedLocation(plan.destination.location);
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Plan update error:', error.response?.data);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Update and refine your itinerary with the latest changes
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20">
          ...
          {step === 1 && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Update your plan details</p>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Update Destination</h2>
                <p className="text-gray-600">Modify your destination location on the map</p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-8">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Update Your Itinerary</h2>
                <p className="text-gray-600">Modify activities and add new ones to your travel plan</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100/50">
                <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  ...
                  Your Updated Itinerary ({formData.activities.length} activities)
                </h3>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <span className={`px-3 py-1 text-xs rounded-full font-medium ${getCategoryColor(activity.category)}`}>
                                {activity.category?.replace('_', ' ') || 'Activity'}
                              </span>
                            </div>
